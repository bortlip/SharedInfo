...
const physicsSource=classicSources.get('physics.js'),trainingSource=classicSources.get('training.js'),simulationSource=classicSources.get('simulation.js'),carsSource=classicSources.get('cars.js');
