...
console.log(`Source checks passed: ${jsFiles.length} JavaScript files parsed; O4 observations/migrations + R4/A3 learning contract validated; vehicle dynamics and all track layouts validated; deterministic learning path guarded; shared helpers are early; no pre-declaration HTML-id/global hazards found.`);
