...
try {
  ...
  for (const file of [
    'state.js','scene.js','tracks.js','cars.js','effects.js','model.js','perception.js','simulation.js','physics.js','session.js','training.js','race.js','brain-viz.js','audio.js','ui.js','runtime.js'
