// Per-car configurable grayscale/RGB POV cameras plus vehicle-local and memorized-track context.
...
function captureObservation(car){
  ...
  const senses=vehicleObservationValues(car),context=trackContextObservationValues(activeTrackId,activeTrackMirror,car.trackArc,trackLength);obs.set(senses,VISUAL_INPUTS);obs.set(context,VISUAL_INPUTS+VEHICLE_SENSE_COUNT);return obs;
}
