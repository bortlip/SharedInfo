...
const sim={running:false,learning:false,pauseAfterLearning:false,mode:'learn',headless:false,speed:1,update:0,experience:0,totalExperience:0,selected:0,cameraMode:'chase',batchReward:0,collisions:0,lastLoss:0,lastPpoMs:0,ppoTotalMs:0,ppoCount:0,ppoBatchTarget:PPO_DEFAULTS.batchTarget,ppoEpochs:PPO_DEFAULTS.epochs,ppoLearningRate:PPO_DEFAULTS.learningRate,ppoClip:PPO_DEFAULTS.clip,experimentSeed:DEFAULT_EXPERIMENT_SEED,rngState:makeExperimentRngState(DEFAULT_EXPERIMENT_SEED),physicsAcc:0,decisionAcc:0,lastTime:performance.now(),temperature:1.35,raceLaps:3,raceTime:0,racePlaces:0,raceFinished:false,raceTrackId:'mixed',trackMode:'mixed',resetMode:'adaptive',adaptiveResetInterval:1,experiencesSinceGridReset:0,simClock:0,measureReal:performance.now(),measureSim:0,achievedSpeed:0,history:[],recentHistory:[],recentSampleAcc:0,lastMetrics:null,trainingWallSeconds:0,trainingSimSeconds:0,bestRunDistance:0,batchResets:0,batchLaps:0,batchOffRoadSeconds:0,batchDriverSeconds:0,batchNoProgressSeconds:0,batchEpisodeDistance:0,batchEpisodes:0,batchForwardMeters:0,batchRoadForwardMeters:0,batchShoulderForwardMeters:0,batchGrassForwardMeters:0,batchBackwardMeters:0,batchProgressReward:0,batchSurfacePenalty:0,batchCollisionPenalty:0,batchTerminalPenalty:0,batchBestRunDistance:0,batchSteerCounts:Array(STEERS.length).fill(0),batchThrottleCounts:Array(LONGITUDINAL.length).fill(0)};
...
function resetBatchTelemetry(){sim.batchReward=0;sim.collisions=0;sim.batchResets=0;sim.batchLaps=0;sim.batchOffRoadSeconds=0;sim.batchDriverSeconds=0;sim.batchNoProgressSeconds=0;sim.batchEpisodeDistance=0;sim.batchEpisodes=0;sim.batchForwardMeters=0;sim.batchRoadForwardMeters=0;sim.batchShoulderForwardMeters=0;sim.batchGrassForwardMeters=0;sim.batchBackwardMeters=0;sim.batchProgressReward=0;sim.batchSurfacePenalty=0;sim.batchCollisionPenalty=0;sim.batchTerminalPenalty=0;sim.batchBestRunDistance=0;sim.batchSteerCounts.fill(0);sim.batchThrottleCounts.fill(0)}
